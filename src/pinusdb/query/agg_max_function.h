...
class MaxValueFunc : public ResultField
{
public:
  MaxValueFunc(size_t comparePos, size_t targetPos, int32_t targetType)
  {
    haveVal_ = false;
  ...
  {
    return new MaxValueFunc<CompareType>(comparePos_, targetPos_, targetType_);
  }
...
template<int CompareType>
class MaxBlockFunc : public ResultField
{
public:
  MaxBlockFunc(size_t comparePos, size_t targetPos, int32_t targetType, Arena* pArena)
  {
    haveVal_ = false;
    targetType_ = targetType;
    targetPos_ = targetPos;
  ...
  virtual ResultField* NewField(int64_t devId, int64_t tstamp)
  {
    return new MaxBlockFunc<CompareType>(comparePos_, targetPos_, targetType_, pArena_);
  }
