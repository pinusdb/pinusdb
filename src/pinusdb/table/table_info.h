...
public:
  ...
  PdbErr_t GetFieldRealInfo(const char* pFieldName, size_t* pFieldPos, int32_t* pFieldType, size_t* pStorePos) const;
  PdbErr_t GetFieldRealInfo(size_t fieldPos, int32_t* pFieldType, size_t* pStorePos) const;
  PdbErr_t GetFieldRealInfo(uint64_t fieldCrc, size_t* pFieldPos, int32_t* pFieldType, size_t* pStorePos) const;
  ...
  size_t GetFixedSize() const { return fixedSize_; }
...
private:
  ...
  std::vector<size_t> storePosVec_;
